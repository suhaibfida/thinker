export function Navbar() {
  return (
    <>
      <div className="flex justify-between bg-gray-300 border border-purple-900 border-5 rounded-full">
        <div className="flex">
          <div className="flex font-bold text-purple-800 text-2xl pl-5">
